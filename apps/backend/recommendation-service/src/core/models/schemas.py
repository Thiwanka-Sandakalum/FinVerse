"""
Pydantic schema definitions for the recommendation system.
"""
from pydantic import BaseModel, Field
from typing import List, Dict, Any, Optional

from src.core.models.model_types import ModelRefreshResultntic schema definitions for the recommendation system.
"""
from datetime import datetime
from pydantic import BaseModel, Field
from typing import List, Dict, Any, Optional

from src.core.models.model_types import ModelRefreshResult
...
class ModelRefreshResponse(BaseModel):
    ...
    success: bool
    message: str
    details: Optional[ModelRefreshResult] = None
